        ...
        {leaders?.map((leader, idx) => {
          ...
          return (
            ...
            >
              ...
              <Typography variant='subtitle2' sx={{ ml: 1, flex: '1 1 100%', display: 'flex', alignContent: 'center', gap: '5px' }}>
                {user.displayName || user.name} <SupporterIcon fontSize="small" color="primary"></SupporterIcon>
              </Typography>
