  ...
  const tiers = [
    {
      ...
      description: ['1 Tree Donated', 'Event Discounts', 'WhatsApp Community Access'],
    ...
    },
    {
      ...
      price: '60',
      buttonText: 'Join Today',
      description: ['3 Trees Donated', 'Event Discounts', 'WhatsApp Community Access'],
    ...
    },
    {
      ...
      price: '100+',
      buttonText: 'Join Today',
      description: ['5+  Tree Donated', 'Event Discounts', 'WhatsApp Community Access'],
      buttonVariant: outlined,
    },
  ];
