...
export type PartialForm = Partial<Form> & { questions?: Partial<FormQuestion>[]; formResponses?: PartialFormResponse[] };

export type PartialFormResponse = Partial<FormResponse> & { user?: PartialUser };
