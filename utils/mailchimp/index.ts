...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
//@ts-ignore
export const mailchimpGet = async (path: string, query?: any) => {
  if (mailchimp) return await mailchimp.get(path, query);
};
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
//@ts-ignore
export const mailchimpPost = async (path: string, params?: any) => {
  if (mailchimp) return await mailchimp.post(path, params);
};
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
//@ts-ignore
